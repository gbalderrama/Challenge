...
TableTools.BUTTONS = {
	...
	"copy": $.extend( {}, TableTools.buttonBase, {
		...
		"fnComplete": function(nButton, oConfig, flash, text) {
			...
			this.fnInfo( '<h6>Copiar filtro - ArBec</h6>'+
				'<p>Se copio '+lines+' fila'+plural+' al portapapeles.</p>',
				1500
			);
		}
	} ),
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6>Vista previa</h6><p>Presione Ctrl+p para "+
		  "imprimir esta pantalla. Presione Escape para salir de esta pantalla.</p>",
		"sMessage": null,
		"bShowAll": true,
		"sToolTip": "Imprimir tabla",
